...
async def handle_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    responses = {
        "voice_mode": (
            ...
            "🗣 Ты можешь:\n"
            "• Говорить команды — «переведи это», «сгенерируй картинку», «озвучь»\n"
            "• Задать вопрос — «Что такое фотосинтез?»\n"
            "• Продиктовать текст — я предложу перевод, если язык другой\n\n"
            "AniAI сам поймёт, какой режим включить 🤖"
        ),
        "voice_help": (
            "🗣 <b>Что ты можешь сказать голосом?</b>\n\n"
            "• «Переведи это» — включу перевод текста\n"
            "• «Сгенерируй картинку с котом» — сделаю изображение\n"
            "• «Озвучь текст» — превращу текст в голос\n"
            "• «Что такое фотосинтез?» — включу GPT и объясню\n"
            "• Продиктуй фразу на другом языке — я сам предложу перевод\n\n"
            "Попробуй — и я всё пойму 🤖"
        ),
