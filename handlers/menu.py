...
async def menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        ...
        [InlineKeyboardButton("🎼 Сгенерировать музыку", callback_data="music_help")],  # добавлена в меню
...
👇 Выбери, с чего хочешь начать:"""
    ...
    if query.data == "music_help":
        await context.bot.send_message(
            chat_id=query.message.chat.id,
            text="🎼 Функция генерации музыки сейчас в разработке."
        )
        return
...
✨ Ты можешь:
• Сказать: «переведи на английский язык я тебя люблю»
• Сказать: «сгенерируй картинку с котом»
• Сказать: «сыграй мелодию для спокойного утра»
• Продиктовать текст — я предложу перевод
• Задать вопрос — и я отвечу
...
• 📌 Контекстный диалог — память последних 5 реплик и автоочистка через 10 минут
